...
class ArticleFormTest extends TestCase
{
    ...
    /** @test */
    function blade_template_id_wired_properly()
    {
    ...
    /** @test */
    function image_is_must_be_of_type_image()
    {
        Livewire::test('article-form')
            ->set('image', 'string-not_allowed')
            ->call('save')
    ...
    /** @test */
    function image_is_must_be_2mb_max()
    {
        Storage::fake('public');
    ...
    /** @test */
    function category_name_must_be_unique()
    {
        $category = Category::factory()->create();
    ...
    /** @test */
    function category_slug_must_be_unique()
    {
        $category = Category::factory()->create();
    ...
    /** @test */
    function slug_only_contain_letters_numbers_dashes_and_underscores()
    {
        Livewire::test('article-form')
            ->set('article.title', 'New Title')
            ->set('article.slug', 'new-article$%^$#')
